...
public class MainFrame extends JFrame {
    ...
    private JButton btnBuscarPorPrio;
    ...
    public MainFrame(){
        ...
        btnBuscarPorPrio.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                tfMostrar_id.setText((puerto.buscaContenedoresBase(Integer.parseInt(tfPrioridad.getText()))));
            }
        });
    }
